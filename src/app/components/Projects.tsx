...
// // 10 Placeholder Projects (Adjust as needed)
// const allProjects = [
//     {
//         id: 1,
...
//         tech: [SiNextdotjs, SiKubernetes, SiDocker, SiAmazon],
...
//         tech: [SiReact, SiJenkins, SiGithubactions, SiAmazon],
//         repo: "https://github.com/your-repo",
//         live: "https://your-live-site.com"
//     },
//     {
...
//         image: "/projects/k8s-auto-scaler.png",
//         description: "Auto-scaling Kubernetes deployments based on real-time metrics.",
//         tech: [SiKubernetes, SiAmazon, SiDocker],
//         repo: "#",
//         live: "#"
//     },
//     {
...
//         image: "/projects/aws-lambda-api.png",
//         description: "A highly scalable serverless API deployed on AWS Lambda.",
//         tech: [SiAmazon, SiNextdotjs],
//         repo: "#",
//         live: "#"
//     },
//     {
...
//         tech: [SiGithubactions, SiJenkins, SiDocker],
//         repo: "#",
//         live: "#"
//     },
//     {
...
//         description: "Using Terraform and AWS to define infrastructure as code.",
//         tech: [SiAmazon, SiDocker, SiNextdotjs],
//         repo: "#",
//         live: "#"
//     },
//     {
...
//         image: "/projects/grafana-monitoring.png",
//         description: "Real-time observability using Grafana, Prometheus, and Loki.",
//         tech: [SiNextdotjs, SiDocker, SiAmazon],
//         repo: "#",
//         live: "#"
//     },
//     {
//         id: 8,
//         name: "Multi-Region Kubernetes Clusters",
//         image: "/projects/multi-region-k8s.png",
//         description: "Deploying Kubernetes clusters across multiple AWS regions.",
//         tech: [SiKubernetes, SiAmazon],
//         repo: "#",
//         live: "#"
//     },
//     {
//         id: 9,
//         name: "Fullstack Logging System",
//         image: "/projects/logging-system.png",
//         description: "A full-stack logging system for distributed applications.",
//         tech: [SiReact, SiNextdotjs, SiDocker],
//         repo: "#",
//         live: "#"
//     },
//     {
...
//         image: "/projects/cloud-cost.png",
//         description: "A tool for analyzing and optimizing cloud infrastructure costs.",
//         tech: [SiAmazon, SiKubernetes, SiDocker],
//         repo: "#",
//         live: "#"
//     }
// ];
...
//                         <motion.div
//                             key={project.id}
//                             className="relative w-full h-64 md:h-80 cursor-pointer group border border-black"
//                         >
//                             <div className="absolute w-full h-full transition-transform transform-style-3d group-hover:rotate-y-180">
...
//                                 {/* Back Side */}
//                                 <div className="absolute w-full h-full bg-gray-800 rounded-lg p-4 flex flex-col justify-between transform rotate-y-180 backface-hidden">
//                                     <div className="flex justify-center gap-2 mb-2">
//                                         {project.tech.map((TechIcon, index) => (
//                                             <TechIcon key={index} className="text-2xl text-emerald-500" />
//                                         ))}
//                                     </div>
//                                     <p className="text-sm text-center">{project.description}</p>
//                                     <div className="flex gap-4 mt-4 justify-center">
//                                         <a href={project.repo} target="_blank" rel="noopener noreferrer"
//                                             className="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-lg flex items-center space-x-2">
//                                             <FaGithub className="text-lg" />
//                                             <span>Repository</span>
//                                         </a>
//                                         <a href={project.live} target="_blank" rel="noopener noreferrer"
//                                             className="bg-emerald-600 hover:bg-emerald-500 text-white py-2 px-4 rounded-lg flex items-center space-x-2">
//                                             <FaExternalLinkAlt className="text-lg" />
//                                             <span>Live Site</span>
//                                         </a>
//                                     </div>
...
//                         <div className="flex items-center justify-center border border-black bg-gray-700 hover:bg-gray-600 text-white cursor-pointer w-full h-64 md:h-80"
//                             onClick={loadMoreProjects}>
//                             <span className="text-xl font-semibold flex items-center gap-2">
//                                 <span>View More Projects</span> <span className="text-2xl">+</span>
//                             </span>
